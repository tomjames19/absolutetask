    ...
    renderConfirmationForm() {
        return (
          <form onSubmit={ this.handleConfirmationSubmit } >
            ...
            <LoaderButton block bsSize="large" disabled={!this.validateConfirmationForm() } type = "submit" isLoading = {this.state.isLoading}
            text = "Verify"
        ...
        return (
          <form onSubmit = {this.handleSubmit} >
            ...
            <ControlLabel> Confirm Password </ControlLabel>
             ...
             <LoaderButton block bsSize = "large" disabled = {!this.validateForm()} type = "submit" isLoading = {this.state.isLoading}
            text = "Signup"
